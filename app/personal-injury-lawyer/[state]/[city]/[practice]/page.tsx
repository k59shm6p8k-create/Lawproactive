                ...
                <AnimatedButton magneticStrength={0.15} hoverScale={1.05}>
                  <TwoStepLeadModal
                    trigger={
                      <Button
                        size="lg"
                        className="cta-glow cta-glow-teal text-white font-bold text-base md:text-lg px-6 md:px-8 py-4 h-auto whitespace-normal text-center leading-snug max-w-[calc(100vw-2rem)] md:max-w-none shadow-xl hover:opacity-90"
              ...
              <AnimatedButton magneticStrength={0.2} hoverScale={1.05}>
                <TwoStepLeadModal
                  trigger={
                    <Button
                      size="lg"
                      className="cta-glow text-white font-bold text-base md:text-lg px-6 md:px-8 py-4 h-auto whitespace-normal text-center leading-snug max-w-[calc(100vw-2rem)] md:max-w-none shadow-2xl hover:opacity-90"
                      style={{ backgroundColor: '#e06e00' }}
                    >
